...
def Get2ptProp(icfg,ism,iPoF=0):
    return qpdir+CreateCfg(icfg)+'_tsrc'+str(ModuloTsrc(icfg,iPoF))+'_sm'+str(ism)+'.prop.lime'

def Get2ptCorr(icfg,ism,jsm,interp,iPoF=0):
    return (cfdir+'twoptsm'+str(ism)+'si'+str(jsm)+'/'+CreateCfg(icfg)+'_k'+str(kud)+'_tsrc'+str(ModuloTsrc(icfg,iPoF))+'sm'+str(ism)+'si'+str(jsm)+'_'+interp+'.2cf.lime')
...
def Get2ptCorrOutput(icfg,ism,jsm,interp,iPoF=0):
    return (cfdir+'/'+CreateCfg(icfg)+'_k'+str(kud)+'_tsrc'+str(ModuloTsrc(icfg,iPoF))+'sm'+str(ism)+'si'+str(jsm)+'_'+interp+'.2cf.lime')
...
def Get3ptCorr(icfg,ism,tsink,Projector,DS,ND):
    ...
    return (cf3ptdir+thisREvecDir+CreateCfg(icfg)+'_k'+str(kud)+'_tsrc'+str(ModuloTsrc(icfg,iPoF))+'sm'+str(ism)+'_'+REvecFlag+'PoF'+str(PoFShifts)+'D'+str(PoFDelta)+
...
def Get3ptCorrjsm(icfg,ism,jsm,tsink,Projector,DS,ND):
    ...
    return (cf3ptdir+thisCMDir+CreateCfg(icfg)+'_k'+str(kud)+'_tsrc'+str(ModuloTsrc(icfg,iPoF))+'sm'+str(ism)+'_si'+str(jsm)+'GMA'+str(Projector)+
